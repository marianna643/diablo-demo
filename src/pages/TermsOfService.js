...
function TermsOfService () {
    return (
    <>
        <h1>DEMO DROP TERMS AND CONDITIONS </h1>
            <h2 className="terms-h2">AGREEMENT TO TERMS</h2> <br />
                <p>These Terms and Conditions constitute a legally binding agreement made between you, whether personally or on behalf of an entity (“you”) and Demo Drop (“we,” “us” or “our”), concerning your access to and use of the [demodrop.com] website as well as any other media form, media channel, mobile website or mobile application related, linked, or otherwise connected thereto (collectively, the “Site”).
            ...
            <h2 className="terms-h2">INTELLECTUAL PROPERTY RIGHTS</h2> <br />
            ...
            <h2 className="terms-h2"> USER REPRESENTATIONS</h2> <br />
                ...
                If you provide any information that is untrue, inaccurate, not current, or incomplete, we have the right to suspend or terminate your account and refuse any and all current or future use of the Site (or any portion thereof). </p> <br />

            <h2 className="terms-h2">USER REGISTRATION</h2><br />

                <p>You may be required to register with the Site. You agree to keep your password confidential and will be responsible for all use of your account and password. We reserve the right to remove, reclaim, or change a username you select if we determine, in our sole discretion, that such username is inappropriate, obscene, or otherwise objectionable.</p> <br />

            <h2 className="terms-h2">PROHIBITED ACTIVITIES</h2><br />
            ...
            <h2 className="terms-h2">USER GENERATED CONTRIBUTIONS</h2><br />
                ...
                Any use of the Site in violation of the foregoing violates these Terms and Conditions and may result in, among other things, termination or suspension of your rights to use the Site. </p> <br/>

        <h2 className="terms-h2">CONTRIBUTION LICENSE</h2> <br />
        ...
        <h2 className="terms-h2">GUIDELINES FOR REVIEWS</h2> <br />

           <p> We may provide you areas on the Site to leave reviews or ratings. When posting a review, you must comply with the following criteria:
